...
import { Functions, Event } from './helpers';
...
export default function up360(element, options) {
    ...
    // fullscreen events
    fullscreen.OnEnabled.Add(function() {
        ui.ToggleFullscreen(true);
    });
    fullscreen.OnDisabled.Add(function() {
        ui.ToggleFullscreen(false);
    });

    // gestures events
    gestures.OnGestureStarted.Add(function() {
        animation.Stop();
    });
...
// Expose the internal event definition
up360.Event = Event;
