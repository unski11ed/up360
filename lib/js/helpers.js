...
*/
function Rectangle(sx, sy, width, height) {
    /*
...
*/
function ScreenRectangle(screenElement) {
    this.left = 0;
    this.top = 0;
    this.bottom = 0;
    this.right = 0;
...
*/
function Event(firstEventHandler) {
    var eventHandlers;
...
var Functions = {
    ...
    */
    ...
    debounce: function(debouncedFunc, timeoutParam) {
        var delay = timeoutParam || 100;
        var timeout;
        ...
        return function() {
            ...
            var functionCall = function() {
                debouncedFunc.apply(context, arguments);
            }
