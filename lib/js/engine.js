...
export function Engine(parentElement, settings) {
    ...
    this.Draw = function (options) {
        ...
        var chunkRender = function (x, y, levelObject) {
            ...
            if (sourceRectangle.intersects(tempRect) || isLowLevelObject) {
                ...
                imageRepository.getImage(currentFrameNormalized, offset, levelObject, function (loadedFromCache) {
                    //Po załadowaniu:
                    var image = this;
    ...
    function zoomTo(value) {
        ...
        var newZoomNormalized = (zoomValue - settings.minZoom) / (settings.maxZoom - settings.minZoom);
        var zoomDir = (newZoomNormalized - _this.ZoomNormalized) < 0 ? -1 : 1;
